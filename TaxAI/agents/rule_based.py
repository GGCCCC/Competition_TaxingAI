...
class rule_agent:
    def __init__(self, envs, args):
        ...
        self.model_path, _, curr_run = make_logpath(algo="rule_based",n=self.args.n_households)
        ...
        if self.wandb:
            wandb.init(
                ...
                project="taxing",
                entity="ggccccai",
                name=self.model_path.parent.parent.name + "-"+ self.model_path.parent.name + "-"+ str(self.args.hidden_size) + f" {curr_run}",
            ...
            if epoch % self.args.display_interval == 0:
                ...
                if self.wandb:
                    ...
                    wandb.log({"mean households utility": mean_house_rewards,
                               ...
                               "steps": now_step})
                print('[{}] Epoch: {} / {}, Frames: {}, gov_Rewards: {:.3f}, house_Rewards: {:.3f}, years: {:.3f}'.format(
