...
class maddpg_agent:
    def __init__(self, envs, args):
        ...
        self.model_path, _, curr_run = make_logpath(algo="maddpgb",n=self.args.n_households)
        ...
        if self.wandb:
            wandb.init(
                ...
                project="taxing",
                entity="ggccccai",
                name=self.model_path.parent.parent.name + "-"+ self.model_path.parent.name + "-"+ str(self.args.hidden_size) + "-"+ str(self.args.batch_size) + "-"+ str(self.envs.gov_task) + f" {curr_run}",
